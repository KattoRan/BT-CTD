...
struct {
  ...
  {"FOR", KW_FOR},
  {"TO", KW_TO},
  {"RETURN", KW_RETURN},  // thêm từ khóa RETURN
  {"STRING", KW_STRING},  // thêm từ khóa STRING
  {"BYTES", KW_BYTES},    // thêm từ khóa BYTES
  {"REPEAT", KW_REPEAT},  // thêm từ khóa REPEAT
  {"UNTIL", KW_UNTIL}     // thêm từ khóa UNTIL
};
// so sánh từ khóa
...
// chuyển tokenType sang chuỗi ký tự, dùng trong thông báo lỗi kiểu “missing keyword THEN”, “unexpected '+'”, …
char *tokenToString(TokenType tokenType) {
  ...
  case KW_RETURN: return "keyword RETURN"; // thêm từ khóa RETURN
  case KW_STRING: return "keyword STRING"; // thêm từ khóa STRING
  case KW_BYTES: return "keyword BYTES";   // thêm từ khóa BYTES
  case KW_REPEAT: return "keyword REPEAT"; // thêm từ khóa REPEAT
  case KW_UNTIL: return "keyword UNTIL";   // thêm từ khóa UNTIL
  ...
  case SB_LSEL: return "\'(.\'";
  case SB_RSEL: return "\'.)\'";
  case SB_MOD: return "\'MOD\'"; // thêm toán tử MOD
  case SB_POWER: return "\'^\'"; // thêm toán tử POWER
  default: return "";
  }
}
