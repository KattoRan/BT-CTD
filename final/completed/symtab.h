...
enum TypeClass {
  TP_INT,
  TP_CHAR,
  TP_STRING, // bạn phải tự định nghĩa
  TP_BYTES,  // bạn phải tự định nghĩa
  TP_ARRAY
};
...
Type* makeStringType(void); // bạn phải tự định nghĩa
Type* makeBytesType(void);  // bạn phải tự định nghĩa
