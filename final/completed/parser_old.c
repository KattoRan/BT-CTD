 ...
 * @version 1.0
 */
// file này dùng để phân tích cú pháp và tạo mã trung gian cho ngôn ngữ lập trình kpl 
#include <stdio.h>
#include <stdlib.h>
...
// Hàm để di chuyển con trỏ token
void scan(void) {
...
// Hàm để biên dịch khai báo hằng
