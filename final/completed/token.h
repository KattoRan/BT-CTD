...
typedef enum {
  ...
  TK_STRING, // thêm loại token cho chuỗi ký tự
  ...
  KW_RETURN, // thêm từ khóa RETURN
  KW_STRING, KW_BYTES, KW_REPEAT, KW_UNTIL, // thêm các từ khóa STRING, BYTES, REPEAT, UNTIL
  ...
  SB_MOD, SB_POWER // thêm toán tử MOD và POWER
} TokenType; 
